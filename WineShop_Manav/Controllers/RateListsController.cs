...
namespace WineShop_Manav.Controllers
{
    public class RateListsController : Controller
    {
        ...
        public RateListsController(WineShopDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await _context.RateLists.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var wine = await _context.RateLists
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var wine = await _context.RateLists.SingleOrDefaultAsync(m => m.ID == id);
            if (wine == null)
            {
                return NotFound();
            }
        ...
        {
            var wine = await _context.RateLists.SingleOrDefaultAsync(m => m.ID == id);
            _context.RateLists.Remove(wine);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.RateLists.Any(e => e.ID == id);
        }
    }
}
